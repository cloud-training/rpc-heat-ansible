...
STACK_NAME=rpc-jenkins-$BUILD_NUMBER-$HEAT_TEMPLATE-$ANSIBLE_TAGS

heat stack-create -f rpc-10.1-$HEAT_TEMPLATE-template.yml -t 240 -P ansible_tags=$ANSIBLE_TAGS $STACK_NAME
