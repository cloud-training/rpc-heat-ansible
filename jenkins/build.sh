...
RPC_RELEASE=${RPC_RELEASE:-"r11.0.0"}
...
heat stack-create -f rpc-$HEAT_TEMPLATE_VERSION-$HEAT_TEMPLATE-template.yml -t 240 -P rpc_release=$RPC_RELEASE -P ansible_tags=`echo $ANSIBLE_TAGS | sed 's/-/,/g'` -e $HEAT_ENVIRONMENT $STACK_NAME
